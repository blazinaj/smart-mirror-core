...
const WikipediaSearchPage = () => {
    ...
    const fetchResults = (resultQuantity) => {
        ...
        <div>
            ...
            <div className="col-xs-9 col-md-7" id={"inputFieldsLogin"}>
                <InputGroup className={"inputGroupLogin"}>
                    <InputGroupAddon addonType="append"><Button onClick={() => fetchResults({key: "one"})}>OneResult</Button></InputGroupAddon>
                    <InputGroupAddon addonType="append"><Button onClick={() => fetchResults({key: "many"})}>ManyResults</Button></InputGroupAddon>
